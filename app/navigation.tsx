...
export default function Navigation() {
  ...
  return (
    !isLogin && (
      <div className="fixed lg:inset-y-0 inset-x-0 lg:inset-x-[unset] bottom-0  left-0 z-30  flex lg:flex-col justify-between items-center lg:px-10 px-6 lg:py-8 py-4 bg-background/80 backdrop-blur-lg lg:bg-transparent  ">
