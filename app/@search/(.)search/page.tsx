...
export default function SearchModal() {
  ...
  return (
    <AnimatePresence>
      {openModal && (
        <div className="fixed inset-0 z-30 flex justify-center lg:pl-35 ">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          <motion.div
            ...
            className="relative z-40 w-full max-w-4xl lg:py-8 py-4 lg:px-0 px-2 h-fit "
          >
            <div className="relative flex items-center bg-background/30 rounded-md backdrop-blur-md">
              <span className="absolute left-2 flex items-center border-r pl-1 pr-2">
                <Search className="lg:size-5 size-4 opacity-50" />
              </span>
              <SpotlightBorderWrapper className="w-full">
                <Input
                  ...
                  className={cn(
                    " w-full lg:h-12 h-9 pl-14 lg:text-base text-sm border border-red-950",
                    value === "movie" ? "pr-30" : "pr-35",
                  )}
                />
                ...
                <Popover open={open} onOpenChange={setOpen}>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      aria-expanded={open}
                      variant="outline"
                      className="border-0 lg:h-11 h-8.5 lg:px-6 bg-transparent"
                    >
            ...
            {isSearching && (
              <motion.div
                ...
                exit={{ maxHeight: 0 }}
                transition={{ duration: 0.25, ease: "easeOut" }}
                className="absolute bg-background/80 backdrop-blur-md w-full lg:mt-0.5 z-10 overflow-auto p-2 custom-scrollbar rounded-sm  space-y-3"
              >
